...
const Contents = () => {
	...
	document.querySelector(".İnfo").remove();
	...
	let Astronomihaberleri = document.createElement("a");



	let Komploteorilerili = document.createElement("li");
	let Astronomihaberlerili = document.createElement("li");
	...
	Astronomihaberleri.textContent = "Astronomihaberleri";





	Komploteorileri.style.cursor = "pointer";
	Astronomihaberleri.style.cursor = "pointer";
	...
	Astronomihaberlerili.appendChild(Astronomihaberleri);


	contentlist.appendChild(Astronomihaberlerili);
	...
	Astronomihaberleri.addEventListener("click", AstronomihaberleriF);
	Komploteorileri.addEventListener("click", Tdergi);
